defmodule PhoenixLiveViewExample.CMSTest do
  use PhoenixLiveViewExample.DataCase

  alias PhoenixLiveViewExample.CMS

  describe "posts" do
    alias PhoenixLiveViewExample.CMS.Post

    @valid_attrs %{body: "some body", enabled: true, title: "some title"}
    @update_attrs %{body: "some updated body", enabled: false, title: "some updated title"}
    @invalid_attrs %{body: nil, enabled: nil, title: nil}
