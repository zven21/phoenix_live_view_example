...
config :phoenix_live_view_example, PhoenixLiveViewExampleWeb.Endpoint,
  url: [host: "localhost"],
  secret_key_base: "Bb/BryXqBNfNvBHhXtXs8v8bW+aovkYaeMA2ZTHpefaJBQEPhfgDVsD8KcvWg/LZ",
  render_errors: [
    view: PhoenixLiveViewExampleWeb.ErrorView,
    accepts: ~w(html json),
    layout: false
  ],
  pubsub_server: PhoenixLiveViewExample.PubSub,
  live_view: [signing_salt: "c7n2JwyG"]
